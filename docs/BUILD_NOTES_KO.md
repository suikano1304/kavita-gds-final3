...
- `0.9.0.2-8` source에서 `linux/amd64`, `linux/arm64` self-contained publish를 수행했습니다.
- 혼합 포맷 시리즈의 EPUB word-count hotfix, GDS archive cover fallback hotfix, 기본 시리즈 정렬 hotfix를 포함했습니다.
...
- `linux/amd64` 이미지는 `0.9.0.2-8` 임시 컨테이너로 기동 검증했습니다.
