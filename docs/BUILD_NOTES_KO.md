...
Kavita official `0.9.0.6` 기반 GDS scanfix 빌드 `9.0.6-1`을 Docker/GHCR 배포용으로 패키징했습니다.
...
- `linux/arm64` 이미지는 같은 소스와 prebuilt production UI로 빌드해 GHCR multi-arch manifest에 포함했습니다.
