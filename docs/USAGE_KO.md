...
```text
ghcr.io/suikano1304/kavita-gds:0.9.0.2-8
```
...
curl -L -o kavita-gds.tar.gz \
  https://github.com/suikano1304/Kavita-GDS/releases/download/v0.9.0.2-8/kavita-gds.tar.gz
```
...
skopeo copy \
  ...
  docker-daemon:local/kavita-gds:0.9.0.2-8
```
...
skopeo copy \
  oci-archive:docker-image/kavita-gds.oci.tar \
  docker://YOUR_REGISTRY/YOUR_NAMESPACE/kavita-gds:0.9.0.2-8
```
