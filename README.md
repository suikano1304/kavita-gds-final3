...
services:
  kavita:
    image: ghcr.io/suikano1304/kavita-gds:0.9.0.2-gds-scanfix-final3-20260530-universal
...
```text
https://github.com/suikano1304/Kavita-GDS/releases/tag/v0.9.0.2-gds-scanfix-final3-universal
```
